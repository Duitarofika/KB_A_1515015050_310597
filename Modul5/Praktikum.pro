DOMAINS
	nama = orang(symbol,symbol)/*(Pertam,Kedua)*/
	hari_lahir = tanggal_lahir(integer,symbol,integer)/*(Hari,Bulan,Tahun)*/
	telepon = symbol/*Nomor Telpon*/
...
% pada saat program di jalankan maka akan menampilkan hasil yang berulang tahun pada bulan ini,% 
%karena program mengeluarkn hasil outputan dengan membaca dan mengeluarkan hasil sesuai bulan yang di atur pada laptop%